...
public class SignUpPage {
	...
	public SignUpPage verifySignUpPageUi() {
		...
		AppLibrary.verifyElement(driver, qlyticsSignUpLogo,true);
		AppLibrary.verifyElement(driver, createYourAccLabel,true);
		AppLibrary.verifyElement(driver, firstNameLabel,true);
		AppLibrary.verifyElement(driver, firtsNameInput,true);
		AppLibrary.verifyElement(driver, lastNameLabel,true);
		AppLibrary.verifyElement(driver, lastNameInput,true);
		AppLibrary.verifyElement(driver, businessEmailLabel,true);
		AppLibrary.verifyElement(driver, businessEmailInput,true);
		AppLibrary.verifyElement(driver, passLabel,true);
		AppLibrary.verifyElement(driver, passwordInput,true);
		AppLibrary.verifyElement(driver, cnfPassLabel,true);
		AppLibrary.verifyElement(driver, cnfPasswordInput,true);
		AppLibrary.verifyElement(driver, phoneNumberLabel,true);
		AppLibrary.verifyElement(driver, phoneNumberInput,true);
		AppLibrary.verifyElement(driver, companyNameLabel,true);
		AppLibrary.verifyElement(driver, companyNameInput,true);
		AppLibrary.verifyElement(driver, jobTitleLabel,true);
		AppLibrary.verifyElement(driver, jobTitleInput,true);
		AppLibrary.verifyElement(driver, registerButton,true);
		AppLibrary.verifyElement(driver, alreadyHaveAccLabel,true);
		AppLibrary.verifyElement(driver, loginLink,true);
		AppLibrary.verifyElement(driver, welcomeLabel,true);
