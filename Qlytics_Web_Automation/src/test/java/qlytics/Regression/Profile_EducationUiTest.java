...
public class Profile_EducationUiTest extends TestBase {
	...
	public void setUp() throws IOException {
		...
		logger = Logger.getLogger("EducationUiTest");
		System.out.println("EducationUiTestStarted");
	...
	public void EducationPageUi() throws Exception {
		...
		new ProfilePage(appLibrary).educationUi();
