...
public class PersonalDetailsEditTest extends TestBase {
	...
	public void setUp() throws IOException {
		...
		logger = Logger.getLogger("PersonalDetailsEditTest");
		System.out.println("PersonalDetailsEditTestStarted");
	...
	public void testPersonalDetailsEdit() throws Exception {

		driver = appLibrary.getDriverInstance();
		appLibrary.launchApp("");
		new LoginPage(appLibrary).Login(emailAddress + "@mailinator.com", Password);
		new HeaderPage(appLibrary).clickOnAccountSetting();
		new ProfilePage(appLibrary).FillPersonalDetailsForm(firstname + " " + lastName, "Tester",
				"3 years of experience in automation testing", "85", "India", "Other - Accounting & Consulting",
				"Jupyter notebook|Amazon aws|Apache", "Private", "More than 30 hrs/week");
		...
		new ProfilePage(appLibrary).FillPersonalDetailsForm(firstname + " " + lastName, "Tester",
				"QA tester experience in jap", "234", "Japan", "Art & Illustration", "Data logistics|Neural networks",
				"Public", "As needed");
		...
		new ProfilePage(appLibrary).verifyPersonaldetails(firstname + " " + lastName, "Tester",
				"QA tester experience in jap", "234", "Japan", "Art & Illustration", "Data logistics|Neural networks",
				"Public", "As needed");
