...
public class Profile_EmploymentHistoryUiTest extends TestBase {
	...
	public void setUp() throws IOException {
		...
		logger = Logger.getLogger("EmplymentHistoryUiTest");
		System.out.println("EmplymentHistoryUiTestStarted");
