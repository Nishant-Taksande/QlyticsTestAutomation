...
public class InvitationVerificationWithSignUpTest extends TestBase {
	...
	public void setUp() throws IOException {
		...
		logger = Logger.getLogger("InvitationVerificationWithSignUpTest");
		System.out.println("InvitationVerificationWithSignUpTestStarted");
	...
	public void testInvitationVerificationWithSignUp() throws Exception {
		String unique = AppLibrary.getFDate() + "_" + AppLibrary.randInt();
		...
		new InvitationPage(appLibrary).verifyInvitationMemberData(firstname, firstname, lastName,
				emailAddress + "@mailinator.com", "Admin");
