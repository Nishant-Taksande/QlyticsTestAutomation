...
public class InvitationUiTest extends TestBase {
	...
	public void setUp() throws IOException {
		...
		logger = Logger.getLogger("InvitationUiTest");
		System.out.println("InvitationUiTestStarted");
	...
	public void testInvitationUi() throws Exception {
		driver = appLibrary.getDriverInstance();
		appLibrary.launchApp("");
		new LoginPage(appLibrary).Login(emailAddress + "@mailinator.com", "Admin123!@#");		
		AppLibrary.clickElement(driver, HeaderPage.organisationButton);
		new InvitationPage(appLibrary).inviteMemberPageUi();
