...
public class PaymentMethodUiTest extends TestBase {
	...
	public void setUp() throws IOException {
		...
		logger = Logger.getLogger("PaymentMethodUiTest");
		System.out.println("PaymentMethodUiTestStarted");
	...
	public void testPaymentMethodUi() throws Exception {
		driver = appLibrary.getDriverInstance();
		...
		new PaymentMethodPage(appLibrary).paymentMethodUi();
